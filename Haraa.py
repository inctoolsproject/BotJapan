...
Amid = ki.getProfile().mid #Kirihara
Bmid = kk.getProfile().mid #Kirihara
Cmid = kc.getProfile().mid #Kirihara
Dmid = ks.getProfile().mid #Kirihara
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                midd = msg.text.replace("Cv 1invite ","")
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Japan team all out","Team bye"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
